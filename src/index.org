...
** Steps to be followed by the students for raising issues
   ...
   An interested student needs to test the IIIT Hyderabad labs (27
...
*** Steps to create a new github repository
   1) Login to your github profile and click on repositories
      tab.
   2) Click *New* button (green coloured) for creating a new
      repository.
   3) Give repository name as "virtual-labs-internship"
   3) Add a description for the repository.
   4) Choose "Public" option to make it visible to everyone.
   5) Select Initialize this repository with a README and give a 2
      line introduction for the repository.
...
*** Parameters to be considered while raising the issues
    ...
    4) Enhancements: If the quality and clarity of the content is not
       upto the mark, new content could be suggested where the content
       to make it more comprehensible. Such issues are always
       welcomed.
...
*** Naming convention to be followed while creating issues
    <lab_name>_<experiment_name>_<in which sub section of experiment the
    bug is detected>
...
** Labels and severity
    ...
    - Category : At any time an issue could be either of the two -
...
* Conclusion
  ...
  opportunity to work as an intern in virtual labs.
