...
** Labels and severity
   ...
   4) Severity : At any given time a issue should only have one of the
      ...
      the new severity label should be checked.
       ...
       +  S1 : This label indicates that the issue affects critical
       ...
       +  S2 : This label indicates that the issues affects major
       ...
       +  S3 : This label indicates that the issue affects minor
