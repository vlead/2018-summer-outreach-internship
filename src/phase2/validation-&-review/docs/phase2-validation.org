...
* Plan of action
  ...
  - Reviews for resolved issues are done during the cycle of
    internship process. In the 3 weeks of bug resolution process,
    Validation of the resolved issues are done by VLEAD mentors once
    in a week.  
  - Final validation of resolved issues would be done by IIIT- H
    domain experts. Interns are expected to visit VLEAD once in a week
    for any course correction or guidance during bug resolution (10
    a.m. - 4p.m. tentative timings).
