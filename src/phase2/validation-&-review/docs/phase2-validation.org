...
* Link for lab code repositories
  ...
  repos from the your personal GitLab accounts. You are free to pick
...
* Status of issues
  ...
  - *Resolved* : This label indicates that when validators reviews the
