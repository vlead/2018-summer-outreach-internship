...
* Lab code repositories
  ...
  + Basic Structural Analysis : 16
  + Colloid Dichroism Spectroscopy : 10
  + Colloid and surface Chemistry : 05
  + Computational Linguistics : 02
  + Computer Graphics : 17
  + Computer Organisation : 13
  + Computer Programming Responsive : 75
  + Cryptography : 27
  + Image Processing : 02
  + Molecular Absorption Spectroscopy : 05
  + Molecular Flouroscence Spectroscopy : 04
  + Molecular Interactions : 02
...
* Steps to be followed by the interns
  ...
  + Step 8 - Once the issue is ready to be moved to production from
    ...
    evaluated and points would be given to them. Based on your
    reviews, you would also be awarded points and maybe awarded with
    surprise gifts at the end of this process. This activity would be
    carried out on every Mondays, Tuesdays and Wednesdays for you in
    your current internship schedule itself. It is expected to go on
    till 4th July, 2018. It should not take more than 1.5 hr/day if you
    do it diligently for the above mentioned period.
