...
Engineering), CE (Civil Engineering) and Chemical Sciences
branches.
...
To apply for the internship program, make sure you have your [[https://github.com/about][GitHub]]
handle and a resume available online. We would request all the
interested students to fill the expression of interest form below.
...
The deadline for applications is April 26th 2018.
...
1) Phase 1 - Selection of interns 
   ...
   The selection process would be based on the initial activity of
   logging bugs by the applied students. The step by step instructions
   are provided in this [[https://github.com/vlead/outreach-internship-program/blob/develop/src/index.org#issuebug-logging-process---selection-of-interns][document]]. Duration for bug logging by the
   students is allowed till 5th May 2018 , 12:00 A.M. IST.

2) Phase 2 - Internship process

   Based on our review of the bugs logged, interns would be selected
   and called for a 3 days Bootcamp (9th-11th May, 2018) at IIITH. For
   this process also we would provide the interns with step by step
   instructions after they are onboarded.
