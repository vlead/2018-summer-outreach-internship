...
** Step 1
   ...
   2) Create a new GitLab project.
      - Steps to create a new gitlab project
        ...
        6) Select  "*outreach-internship*" in "Select members
        to invite" section. 
        7) Select ¡±master¡± for ¡°Choose a role permission¡±
           field.
        8) Set the "Access expiration date" as "*09 May,
           2018*
        9) Click on "*Add to project*".

** Step 2
  1) Go to the [[www.http://vlabs.ac.in][Virtual Labs website]] and hover on Institutes
...
* Time limit for raising issues
   The students are allowed to log defects till *7th May*
   2018, 08:00
   A.M. IST.
