#+TITLE: Phase 2 : Validation of resolved issues
#+AUTHOR: VLEAD
#+DATE: [2018-04-12 Mon]
...
* Validation of issues
  ...
  <labname>-iiith
* Plan of action
  - Logging issues is from 30th April - 5th May, 2018
  - Result declaration is on  8th May, 2018
  - Boot Camp could start from 9th May - 11th May, 2018 
  - Bug fixing begins from May 14th - 4th June, 2018
  - Reviews for resolved issues are done during the cycle of
    internship process. In the 3 weeks of bug resolution
    process, Validation of the resolved issues are done by VLEAD mentors once in a week. 
    Final validation of 
    IIIT- H domain experts. Interns are expected to visit
    VLEAD once in a week for any course correction or
    guidance during bug resolution (10 a.m. -
    4p.m. tentative timings).

* Validation and review after raising bugs
...
* Validation and review after fixing bugs
** Steps to reproduce

** Ranking/scoring based on the severity level
